...
{
  "id": "Chapter1Section6-7-3",
  "level": "2",
  "url": "Chapter1Section6.html#Chapter1Section6-7-3",
  "type": "Checkpoint",
  "number": "1.5.66",
  "title": "",
...
},
{
  ...
  "number": "4.1.26",
  "title": "",
  "body": "  [Exercise Answers]    A and C are exponential functions, they grow by a percentage, not a constant number.     is growing faster ( ), but after 3 years still has a higher account balance     , .     , so , , so , . Thus, , , .    An initial substance weighing 20 grams is growing at a continuous rate of 12% per day.       "
},
{
  "id": "Chapter4Section2",
  "level": "1",
